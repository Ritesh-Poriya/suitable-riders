...
export class FirebaseModule {
  public static forRoot(options: FirebaseModuleOptions): DynamicModule {
    ...
    return {
      ...
      exports: [provider, FirebaseFCMService, FirebaseAuthService],
      module: FirebaseModule,
      providers: [provider, FirebaseFCMService, FirebaseAuthService],
    };
  }
  ...
  public static forRootAsync(
    ...
    return {
      ...
      exports: [firebaseProvider, FirebaseFCMService, FirebaseAuthService],
    };
  }
